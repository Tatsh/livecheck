...
1. Run `uv run pytest --cov livecheck --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov livecheck --cov-branch --cov-report term-missing:skip-covered`
