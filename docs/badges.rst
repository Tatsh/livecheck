.. only:: html
   ...
   .. image:: https://img.shields.io/github/commits-since/Tatsh/livecheck/v0.2.6/master
      :target: https://github.com/Tatsh/livecheck/compare/v0.2.6...master
   ...
   .. image:: https://results.pre-commit.ci/badge/github/Tatsh/livecheck/master.svg
      :target: https://results.pre-commit.ci/latest/github/Tatsh/livecheck/master
